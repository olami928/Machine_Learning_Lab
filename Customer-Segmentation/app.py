...
with col2:
    st.subheader('Customer Sepnt Time')
...
with col1:
    ...
    visit_per_week = st.number_input('Visit Per Week', min_value=0, max_value=20, value=4)

with col2:
    st.subheader('Promotion Interest')
    promotion_interest = st.number_input('Promotion Interest', min_value=1, max_value=10, value=7)
